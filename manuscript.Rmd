...
abstract          : "In times of crisis such as the COVID-19 pandemic, citizens need to stay informed about recent political events. To this end, people increasingly use social media. However, being particularly engaging, many find it hard to disconnect from social media, especially during times of crisis. Using data from the Austrian Corona Panel Project consisting of 3,485 participants from 32 waves, controlling for several stable and varying confounders, the results showed that COVID-19 related social media use reduced facets of well-being. However, the effects were very small. Other factors such as health, income, exercise, or internal locus of control showed larger and more meaningful effects."
...
The most relevant deviations are reported below, and a complete list of all changes can be found in the online [companion website](https://tdienlin.github.io/Austrian_Corona_Panel) (https://tdienlin.github.io/Austrian_Corona_Panel).
...
For more information on the analyses, a complete documentation of the models and results, and all additional analyses, see [companion website](https://tdienlin.github.io/Austrian_Corona_Panel).
...
All the stimuli, presentation materials, analysis scripts, and a reproducible version of the manuscript can be found on the companion website (https://tdienlin.github.io/Austrian_Corona_Panel).
